...
import { Cpu, Cloud, Wind, Lock, ShieldCheck } from 'lucide-react';
  ...
  return (
    <section id="tech" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-slate-900 rounded-xl p-8 md:p-12 text-white flex flex-col md:flex-row items-center gap-8 shadow-2xl">
